        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invoices_MemberProfiles_MemberID",
                        column: x => x.MemberID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Memberships_SubscriptionPlans_PlanID",
                        column: x => x.PlanID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wallets_MemberProfiles_MemberID",
                        column: x => x.MemberID,
                        principalTable: "MemberProfiles",
                        principalColumn: "MemberID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_MemberProfiles_MemberID",
                        column: x => x.MemberID,
                        principalTable: "MemberProfiles",
                        principalColumn: "MemberID",
                        onDelete: ReferentialAction.Restrict);
